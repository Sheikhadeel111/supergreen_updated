...
overflow-x: hidden;">
      ...
      <div class="col-lg-3 text-center price-column" style="">
        ...
        <h5>
          <div id="myDIV"> <p class="ptext text-center"></p></div></h5>
      </div>
    </div>
  </div>
  </div>
   ...
   var currentPrice = $("#price").val();
    ...
    function toppingSize(ele,id,size){ //topping size
     ...
     if($("#"+id+"light").hasClass("active")){
      ...
      $('.ptext').append("<div data-salad-id='" + id + "'><div style='display:inline' data-size-id='" + id + "'>" + size + "</div></div>");

       // $("."+abc).find("p").children("div[data-salad-id='" + $(ele).data('id') + "']").remove();
