      ...
      <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
          ...
          <li class="<?php echo isset($this->selected_parent_tab) && $this->selected_parent_tab=='category'?'active open':''; ?>  nav-item"><a href="javascript:;"><i class="fa fa-pie-chart"></i><span class="menu-title" data-i18n="nav.templates.main">Category</span></a>
           ...
           <li class="<?php echo isset($this->selected_parent_tab) && $this->selected_parent_tab=='Coupon'?'active open':''; ?>  nav-item"><a href="javascript:;"><i class="fa fa-gift"></i><span class="menu-title" data-i18n="nav.templates.main">Coupon</span></a>
            <ul class="menu-content">
              <li class="<?php echo($this->selected_tab == 'add_coupon' ? 'active' : ''); ?>"><a class="menu-item" href="<?php echo base_url('admin/coupon/manage_view'); ?>"><i></i><span data-i18n="nav.templates.vert.main">Add Coupon</span></a>
              </li>
              <li class="<?php echo($this->selected_tab == 'view_coupon' ? 'active' : ''); ?>"><a class="menu-item" href="<?php echo base_url('admin/coupon/'); ?>"><i></i><span data-i18n="nav.templates.horz.main">View Coupon</span></a>
              </li>
            </ul>
          </li>
