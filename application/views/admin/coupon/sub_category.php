      ...
      <div class="row">
        <div class="col-md-12">
          <div class="card">
            ...
            <!-- href="<?php echo base_url('admin/category/subcatIngredients/').$value->cat_id; ?>" -->
                  ...
                  { 
                    ...
                    <div id="<?php echo "item_".$value->cat_id; ?>" class="list-group-item">
                      ...
                      <div style="float: right;">
                         <div  class="btn btn-info btn-secondary box-shadow-2 mr-1 mb-1" data-toggle="tooltip" data-placement="top" title="" data-original-title="Set Display Position of ingredients of <?php echo  $value->name; ?> "><i class="fa fa-arrows-v" aria-hidden="true"></i>
                        </div>
